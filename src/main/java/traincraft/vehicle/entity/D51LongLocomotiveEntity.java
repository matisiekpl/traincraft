...
public class D51LongLocomotiveEntity extends SteamLocomotiveEntity {
    ...
    public D51LongLocomotiveEntity(EntityType<? extends D51LongLocomotiveEntity> type, Level level) {
        super(type, level);
    }

    @Override
    public VehicleDefinition spec() {
        return VehicleDefinitions.LOCO_STEAM_D51_LONG;
    }
    ...
    protected Item getDropItem() {
        return ItemRegistry.LOCO_STEAM_D51_LONG.get();
    }
